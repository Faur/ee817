...
class DDPGLearner(Learner):
    ...
    '''
    def __init__(self, observation_space, action_space, a_lr=0.0001, c_lr=0.001, gamma=0.99, tau=0.001):
        ...
        self.actor = ActorNetwork(self.sess, state_dim, action_dim, action_bound,
                             self.actor_learning_rate, self.tau)

        self.critic = CriticNetwork(self.sess, state_dim, action_dim,
                               self.critic_learning_rate, self.tau, self.actor.get_num_trainable_vars())
    ...
    def train(self, s_batch, a_batch, r_batch, t_batch, s2_batch):
        ...
        # Todo: Why re-calculate the actions here?
