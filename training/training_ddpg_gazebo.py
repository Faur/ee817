...
from backups import continuifier as cont
...
setting = "ddpg_gazebo"
from unused.globals_ddpg_gazebo import *
...
def main():
    ...
    env = cont.Coninuified(NR_ACTIONS, NR_OBSERVATIONS, ENV_NAME, red_fact=20, is_a_gazebo=True, monitor_dir=MONITOR_DIR)
    ...
    if "ddpg" in setting:
        learner = DDPGLearner(observation_space=env.observation_space, action_space=env.action_space,
                              n_hidden=SIZE_HIDDEN, a_lr=ACTOR_LEARNING_RATE, c_lr=CRITIC_LEARNING_RATE)
