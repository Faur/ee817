...
import gym_gazebo_dqn.memory

from gym_gazebo_dqn.liveplot import LivePlot
from gym_gazebo_dqn.liveplot import pause
...
class DeepQ:
    ...
    def __init__(self, inputs, outputs, memorySize, discountFactor, learningRate, learnStart):
        ...
        self.memory = gym_gazebo_dqn.memory.Memory(memorySize)
...
def main(nr_actions=11, nr_obs=100):
