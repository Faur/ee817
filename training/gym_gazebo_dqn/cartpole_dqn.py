...
if __name__ == '__main__':
    ...
    outdir = '/tmp/cartpole-dqn_experiments/'
    ...
    weights_path = '/tmp/cartpole_dqn_ep200.h5'
    monitor_path = '/tmp/cartpole_dqn_ep200'
    params_json  = '/tmp/cartpole_dqn_ep200.json'
...
#         network_inputs = 100
#         network_outputs = 21
        network_inputs = 4 #20 #Todo   # these are continuous vectors
        network_outputs = 2  #21 #0:go, 1:Left, 2:Right   # these are discrete values
...
#         observation = observation.repeat(5) #ccsmm,dbg
        ...
        for t in xrange(steps):
            ...
            expRate = explorationRate if epoch % test_every != 0 else 0.05
            action = deepQ.selectAction(qValues, expRate)
...
#                         env.monitor.flush()
                        ...
                        parameter_keys = ['epochs','steps', 'test_every', 'updateTargetNetwork','explorationRate','minibatch_size','learnStart','learningRate','discountFactor','memorySize','network_inputs','network_outputs','network_structure','current_epoch']
                        parameter_values = [epochs, steps, test_every, updateTargetNetwork, explorationRate, minibatch_size, learnStart, learningRate, discountFactor, memorySize, network_inputs, network_outputs, network_structure, epoch]
